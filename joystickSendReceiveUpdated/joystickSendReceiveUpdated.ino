...
{
    encoding_v = encoding_v + 100;
    encoding_w = encoding_w + 100;
    ...
    Serial.write("E");
    Serial.write("C");
    Serial.write(encoding_data[0]);
    Serial.write(encoding_data[1]);
    Serial.write(encoding_data[2]);
    Serial.write(encoding_data[3]);
    Serial.write(encoding_data[4]);
    Serial.write(encoding_data[5]);
    Serial.write(encoding_data[6]);
    Serial.write(encoding_data[7]);
    Serial.write("E");
}
